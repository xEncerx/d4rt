  ...
  static BridgedClass get definition => BridgedClass(
        ...
        constructors: {
          '': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError(
                "Uint16List constructor expects one int argument (length).");
          },
          'fromList': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError(
                "Uint16List.fromList expects one List<int> argument.");
          },
          'view': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError(
                "Uint16List.view expects ByteBuffer and optional offset/length arguments.");
          },
          'sublistView': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError(
                "Uint16List.sublistView expects TypedData and optional start/end arguments.");
          },
        },
        methods: {
          ...
          '[]=': (visitor, target, positionalArgs, namedArgs) {
            ...
            throw RuntimeError(
                "Uint16List[index] = value expects int index and int value.");
          },
        ...
        getters: {
          ...
          'lengthInBytes': (visitor, target) =>
              (target as Uint16List).lengthInBytes,
          'offsetInBytes': (visitor, target) =>
              (target as Uint16List).offsetInBytes,
          ...
          'runtimeType': (visitor, target) =>
              (target as Uint16List).runtimeType,
        },
      );
}
